...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.CseSpringCodegen", date = "2017-11-22T13:56:48.599Z")

@RestSchema(schemaId = "cpetest")
@RequestMapping(path = "/kingyl", produces = MediaType.APPLICATION_JSON)
